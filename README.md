...
│           ├── P9_simulados_por_faixa.png
│           └── P10_clustermap_correlacoes.png
├── docs/
...
| `P9_simulados_por_faixa.png` | Barras empilhadas a 100% mostrando a distribuição de simulados realizados (0 a 3) dentro de cada faixa de nota. |
| `P10_clustermap_correlacoes.png` | Clustermap (seaborn + scipy) da matriz de correlação de 11 atributos numéricos, com agrupamento hierárquico automático por similaridade de correlação. |
